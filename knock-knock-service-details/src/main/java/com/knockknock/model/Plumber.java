...
public class Plumber {
	...
	public Plumber(String serviceMan, Long contactNo, Double rating, String serviceAvailability) {
	...
	public String toString() {
		return "Plumber [id=" + id + ", contactNo=" + contactNo + ", rating=" + rating + ", serviceAvailability="
				+ serviceAvailability + "]";
	}
